...
player = tkinter.Tk()
player.title("Music Player -- Codex Cue")
player.geometry("340x270")
...
playing = tkinter.Listbox(player,font="Helvetica 12 bold",width=38,bg="white",fg="green",selectmode=tkinter.SINGLE)
...
pauseB = tkinter.Button(player, width=7, height=1, font="Helvetica", text="Pause", command=pause, bg="orange", fg="black").grid(row=2,column=1)
resumeB = tkinter.Button(player, width=9, height=1, font="Helvetica", text="Resume", command=resume, bg="lightblue", fg="black").grid(row=2,column=2)
